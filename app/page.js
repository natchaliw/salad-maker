...
export default function Home() {
  ...
  return (
    ...
    <div className=" flex gap-10 w-full h-screen">
      <div className="container mx-auto flex gap-10 w-screen h-screen">
        <div className="w-full min-h-screen py-12 pr-10 pl-0 gap-8 flex flex-col items-center"> 
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="relative">
              ...
              <div className="absolute md:bottom-2 lg:bottom-3 xl:bottom-10 md:left-4 lg:left-4 xl:left-10">
                <h2 className="text-md lg:text-xl xl:text-2xl 2xl:text-[32px] font-bold  2xl:leading-[48px] text-darkbluecolor">Fresh &</h2>
                <h2 className="text-md lg:text-xl xl:text-2xl 2xl:text-[32px] font-bold  2xl:leading-[48px] text-darkbluecolor">tasty salads</h2>
                <p className="text-sm md:text-xs font-normal text-darkbluecolor mt-2 2xl:mt-5 ">Relax please, we've got you</p>
                <p className="text-sm md:text-xs font-normal leading-6 text-darkbluecolor">covered every day of the week</p>
              </div>
            </div>
